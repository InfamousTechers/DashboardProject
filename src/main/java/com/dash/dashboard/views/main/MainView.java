package com.dash.dashboard.views.main;
...
@PWA(name = "Dashboard", shortName = "Dashboard", enableInstallPrompt = false)
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "Dashboard logo"));
